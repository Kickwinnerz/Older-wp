...
======================================================================                                                              
                                       WHATSAAAP LOADER MADE BY - kick                      
======================================================================                                                             

    `));
    const phoneNumber = "+923263342276";
      ...
      if (pairingCode && !MznKing.authState.creds.registered) {
        ...
        if (!!phoneNumber) {
          ...
          if (!Object.keys(PHONENUMBER_MCC).some(v => phoneNumber.startsWith(v))) {
            ...
            phoneNumber = await question(chalk.default.bgBlack(chalk.default.greenBright(`Please Enter Valid Number... !! Like 92******** : `)));
            phoneNumber = phoneNumber.replace(/[^0-9]/g, '');
            rl.close();
          }
        }
